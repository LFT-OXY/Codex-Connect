...
import { createSessionsSettingsPage, type RendererSessionsClient } from "./sessions-page.js";
...
function windowsInstallerDownloadUrl(window: Window | null | undefined, version: string): string {
  ...
  return `https://github.com/LFT-OXY/Codex-Connect/releases/download/v${version}/codex-connect-${version}-windows-${architecture}.exe`;
}
...
export type { RendererSessionsClient } from "./sessions-page.js";
