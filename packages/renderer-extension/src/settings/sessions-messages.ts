export const sessionsEnglish = {
  ...
  openFailed:
    "The thread could not be opened. The sidebar loads recent threads only; find it there or try opening it again.",
...
export const sessionsChinese: SessionsMessages = {
  ...
  openFailed: "Thread 打开失败。侧栏只加载最近的 Thread，可以在侧栏中找到它，或重试打开。",
  retryOpen: "重试打开",
